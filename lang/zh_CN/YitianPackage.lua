...
return {
	...
	["yx_sword"] = "杨修剑",
	[":yx_sword"] = "装备牌，攻击范围：３\
	武器特效：当你的【杀】造成伤害时，可以指定攻击范围内的一名其他角色为此伤害来源，若如此做，杨修剑归该角色所有。",
	...
	["zhangjunyi"] = "张儁乂",
	["jueji"] = "绝汲",
	[":jueji"] = "你可跳过你的出牌阶段并选择一名角色拼点：若你赢，你获得对方的拼点牌，并可立即再次与其拼点，如此反复，直到你没赢或不愿意继续拼点为止。", 
	["@jueji"] = "绝汲",	
	["@jueji-pindian"] = "你可跳过你的出牌阶段并选择一名角色拼点：若你赢，你获得对方的拼点牌，并可立即再次与其拼点，如此反复，直到你没赢或不愿意继续拼点为止。",
	["$jueji"] = "何人能及？",
	["~zhangjunyi"] = "张儁乂阵亡",
	...
	[":caizhaoji_hujia"] = "回合结束阶段，你可以进行判定：若为红色，立即获得此生效后的判定牌，如此往复，直到出现黑色为止，连续发动3次后将武将牌翻面。",
